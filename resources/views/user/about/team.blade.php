							...
							<div class="container">
								<div class="row">
									<div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
										...
										<p class="normal-text">Su experiencia y formación le han otorgado el conocimiento de la ciudad, al igual que un fuerte compromiso social e interés en fortalecer el bienestar de la comunidad</p>

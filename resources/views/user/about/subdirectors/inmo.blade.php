					...
					<div class="container">
						<div class="row">
							...
							<p class="normal-text">En el área de Gestión Inmobiliaria nuestra líder es Nathalia Gallego Mejía, Arquitecta de la Universidad Nacional de Colombia Sede Medellín, Magíster en Arquitectura de la Universidad de Houston - Texas, con habilidades para la planeación, dirección, gestión y seguimiento de proyectos, con amplia experiencia administrativa y técnica en los sectores hospitalario, educativo, inmobiliario, urbano y de APP's, en el ámbito público y privado.</p>
								...
								<p class="normal-text">Como directora técnica de la Agencia APP, Nathalia ha logrado consolidar y direccionar un equipo de profesionales idóneos, con alto sentido de responsabilidad, adaptabilidad y compromiso, con actitud positiva, proactiva, propositiva, con buenas relaciones interpersonales y comprometidos hacia el logro de los objetivos financieros, administrativos, contables y de mejora continua planteados, no solo en aras al cumplimiento de las metas del plan de Desarrollo "Medellín Futuro 2020-2023”, si no hacia el cumplimiento de la misión y visión de la Agencia APP.</p>	
							<!-- <p class="normal-text">En el área de Gestión Inmobiliaria nuestra líder es la ingeniera civil Natacha Gómez, quien además es especialista en gerencia de proyectos de la Universidad EAFIT. Natacha tiene en su hoja de vida experiencia en el sector privado y público. Trabajó con Vértice Ingeniería S.A, inicialmente; posteriormente, laboró en la Unidad de Gestión de Riesgos del Área Metropolitana del Valle de Aburrá. En diciembre de 2017 asumió su actual cargo como subdirectora de gestión inmobiliaria.</p> -->
							</div>
							<div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200"><img alt="" class="img-fluid animated" src="{{asset('assets/img/funcionarios/imgDirectoraTecnica.png')}}"></div>
						</div>
					</div>
				</section><!-- End Hero -->
			</div>

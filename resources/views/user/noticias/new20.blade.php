...
<section>
		...
		<div class="vlt-page-title-hero vlt-page-title-hero--work vlt-page-title-hero--lg jarallax">
			...
			<div class="vlt-page-title-hero__content">
							...
							Incentivos bienes de interes cultural
							</h1>
...
Con estímulos a propietarios de bienes de interés cultural, Medellín incentiva el cuidado del patrimonio arquitectónico
                                ...
                                <li> Entre los estímulos están la exención del impuesto predial y compensaciones por construcción en altura. 
</li>

<li>  De los más de 400 BIC de tipo arquitectónico en la ciudad, recientemente se han establecido más de 90 convenios para eximir del pago del predial. </li>
...
<br>
	...
	<footer class="vlt-single-post__footer">
				...
				<a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="https://twitter.com/intent/tweet?text=https://www.app.gov.co/noticias/new20" rel="nofollow" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>

				<a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.app.gov.co/noticias/new20" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>

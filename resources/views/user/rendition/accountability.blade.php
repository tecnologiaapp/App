...
@section('body_color', '#FEF38F;')
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 offset-md-1">
							<iframe src="{{ asset('assets/pdf/resolucion-079-de-junio-12-de-2019-rendicion-de- cuentas.pdf') }}" width="100%" height="900px"></iframe>
						</div>
					</div>
				</div>	
			</section>
	...
	<footer class="vlt-single-post__footer">
				...
				<a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="https://twitter.com/intent/tweet?text=https://www.app.gov.co/rendición/de/cuentas/accountability" rel="nofollow" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>

				<a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.app.gov.co/rendición/de/cuentas/accountability" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>

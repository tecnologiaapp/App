	...
	<section>
		...
		<div class="container">
          ...
          <h2>Rendición de cuentas 2021</h2>
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/tmykJWQKMIo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

				<h4 class="text-center mb-5">Para conocer más, click en la imagen</h4>

				<div style="text-align:center;" > <a href="{{ asset('assets/pdf/Rendición-de-cuentas-2021.pdf')}}" target="_blank">	<img src="{{ asset('assets/img/news/final.PNG')}}" alt=""> </a> </div>
			<br>
...
<div class="container">
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <iframe src="{{ asset('assets/pdf/resolucion-079.pdf') }}" width="100%" height="900px"></iframe>
        </div>
    </div>
</div>	
</section>
...
<div class="section-title">
	...
	<footer class="vlt-single-post__footer">
				...
				<a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="https://twitter.com/intent/tweet?text=https://www.app.gov.co/rendición/de/cuentas2021" rel="nofollow" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>

				<a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.app.gov.co/rendición/de/cuentas2021" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>

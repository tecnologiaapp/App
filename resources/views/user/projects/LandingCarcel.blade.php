...
@include('includes.header.LandingCarcel')
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" style="padding-top:70px;">
      ...
      <iframe src="https://www.youtube.com/embed/8vadSCij5Ew" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  ...
  <main id="main">
    ...
    <!-- ======= About Us Section ======= -->
    <section id="contexto" class="about">
...
<section id="features" class="features">
      ...
      <div class="section-subtitle" style="margin-top: 50px;">
          <!-- <h4 style="color:black; text-align:center;">Con la Cárcel Metropolitana para sindicados se logrará:</h4> -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/carcel/1.jpg" class="d-block w-100" >
  
    </div>
    <div class="carousel-item">
      <img src="assets/img/carcel/2.png" class="d-block w-100">
   
    </div>
    <div class="carousel-item">
      <img src="assets/img/carcel/3.png" class="d-block w-100">
...
<!-- <section id="why-us" class="why-us">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “José Daniel Torres, sindicado. </i></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
            <iframe width="100%"  height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “La situación de la población privada de la libertad en Colombia es preocupante” </i></h4>
              <p>Mateo Gómez, personero delegado de Medellín.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
            <iframe width="100%"  height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “Los sindicados están en el limbo. Deben ser cuidados desde lo emocional y lo físico” </i></h4>
              <p>Miryam Escobar, de la Fundación Libres en Prisión.</p>
            </div>
          </div>
    ...
    <section id="donde" class="why-us" style="padding-top: 20px; background-color:#f6f9fe;" >
      <div class="container" data-aos="fade-up">
  ...
  <!-- <section id="why-us" class="why-us">
      ...
      <div class="section-title">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
            <iframe width="100%"  height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “El tiempo que estuve privado de la libertad fue, quizá, de lo más difícil que yo he vivido con mi familia”</i></h4>
              <p>Jeins Durán, exsindicado.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
            <iframe width="100%"  height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “Toda persona es inocente hasta que se demuestre lo contrario y lo contrario se demuestra con una sentencia judicial”</i></h4>
              <p>Juan David Posada, docente e investigador de la Universidad de Antioquia.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/k7A6Ugs0NFw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              <h4 style="font-family: MajritTx,serif;"><i> “Estructurar una factibilidad, para una Asociación Público Privada, de las características de la cárcel ha sido una tarea titánica”</i></h4>
              <p>Rodrigo Foronda Morales, director general de la Agencia APP.</p>
            </div>
          </div>
    ...
    <section id="beneficios" class="why-us">
      <div class="container" >
      ...
      <div class="container">
        ...
        <div class="row counters position-relative">
          ...
          <div class="col-lg-3 col-6 text-center">
              ...
              <div align="center">
              <h2 class="counter" style="  display: inline-block;
    margin: 15px 0;
    font-size: 35px;
    color: #ffffff;">1.339</h2>
    ...
    margin: 15px 0;
    font-size: 35px;
    color: #ffffff;">4.000</h2><span style="font-size:25px;padding-left: 5px;"> <b> m²</b></span>
    ...
    margin: 15px 0;
    font-size: 35px;
    color: #ffffff;">30.000</h2><span style="font-size:25px;padding-left: 5px;"> <b> m²</b></span>
    ...
    margin: 15px 0;
    font-size: 35px;
    color: #ffffff;">15 </h2><span style="font-size:25px;padding-left: 5px;"> <b> años</b></span>
      ...
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="card" style="background-color:#ffd178;">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{route('contact.send')}}"enctype="multipart/form-data" >
                      ...
                      <button type="submit" class="btn btn-primary float-end mt-1" style="background-color:#b3348a; border-color:#b3348a;">Enviar mensaje</button>
                  </form>
                </div>
              </div>
          </div>
          <div class="col-md-4">
              ...
              <a href="https://docs.google.com/forms/u/1/d/e/1FAIpQLSf4kgUoA-iOt07BfhnmdrrL2NNrEyy0VpoyyVMrrpgNH5zVZw/viewform?urp=gmail_link" class="btn btn-primary btn-block" style="background-color:#b3348a; border-color:#b3348a;" target="_blank">Suscríbete</a>
              </div>
          </div>
        </div>
      </div>
...
<!-- Vendor JS Files -->
<script src="https://kit.fontawesome.com/5373575732.js" crossorigin="anonymous"></script>

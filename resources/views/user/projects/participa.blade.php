		...
		<div class="container">
			<article class="vlt-single-post">
				<div class="vlt-animation-block mb-5 text-center" data-aos="fade" data-aos-delay="0">
					<h1 class="m-0" style="font-size: 4rem;"><span class="vlt-highlight">Participa</span></h1>
				</div>
				<div class="content">
					<article class="post">
						...
						<div class="post-body">
							<h5>Participación para la identificación de problemas y diagnóstico de necesidades</h5><a class="post-link" href="{{route('user.projects.aeep')}}" target="_blank">Participa</a>
						</div>
					</article>
					<article class="post">
						<div class="post-header">
						...
						<div class="post-body">
							<h5>Planeación y/o presupuesto participativo</h5><a class="post-link" href="{{route('user.transparency.planning.action_plan')}}" target="_blank">Participa</a>
						</div>
					</article>
					<article class="post">
						<div class="post-header">
						...
						<div class="post-body">
							<h5>Participación y consulta ciudadana de proyectos, normas, políticas o programas</h5><a class="post-link" href="{{route('user.projects.index')}}" target="_blank">Participa</a>
						</div>
					</article>
					<article class="post">
						<div class="post-header">
						...
						<div class="post-body">
							<h5>Colaboración e innovación abierta</h5><a class="post-link" href="https://agenciaapp.maps.arcgis.com/apps/dashboards/c4d6f9703d434fa88b6fd266ae8c3f70" target="_blank">Participa</a>
						</div>
					</article>
					<article class="post">
						<div class="post-header">
						...
						<div class="post-body">
							<h5>Rendición de cuentas</h5><a class="post-link" href="{{route('user.rendition.cuentas-2021')}}" target="_blank">Participa</a>
						</div>
					</article>
					<article class="post">
						<div class="post-header">
						...
						<div class="post-body">
							<h5>Control ciudadano</h5><a class="post-link" href="{{route('user.rendition.cuentas')}}" target="_blank">Participa</a>
						</div>
					</article>
				</div>
			</article>

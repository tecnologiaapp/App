...
<section>
		...
		<div class="vlt-page-title-hero vlt-page-title-hero--work vlt-page-title-hero--lg jarallax">
			...
			<div class="vlt-page-title-hero__content">
							...
							Arte urbano en intercambio vial Bulerías
							</h1>
					...
					<div class="row">
						<div class="col-md-10 offset-md-1">
							<div class="text-justify">
                               ...
                               <div align="center"> <img src="{{ asset('assets/img/Proyectos/Bulerías.webp')}}" alt=""></div>
	...
	<footer class="vlt-single-post__footer">
				...
				<a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="https://twitter.com/intent/tweet?text=https://www.app.gov.co/proyectos/bulerias" rel="nofollow" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>

				<a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.app.gov.co/proyectos/bulerias" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>

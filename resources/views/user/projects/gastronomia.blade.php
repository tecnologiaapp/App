...
<body id="page-top">
	...
	<section style="padding-bottom: 0rem;">
		<picture><source media="(min-width: 800px)" srcset="{{ asset('assets/img/Proyectos/empren.jpg') }}"> <source media="(min-width: 330px)" srcset="{{ asset('assets/img/Proyectos/empren-mo.jpg') }}"> <img alt="Ejemplo" src="{{asset('assets/img/Proyectos/empren.jpg')}}" style="width:100%"></picture> <!-- <img src="{{ asset('assets/img/Proyectos/header-gastro.png') }}" style="position: relative; width:100%; height:700px; background-size: 100% 100%;" /> -->
	...
	</header><img src="{{asset('assets/img/Proyectos/banner-gastronomia.png')}}" style=" width:100%;"> <!-- App features section-->
	<section>
		<div class="container px-5">
			<div class="row gx-5 align-items-center">
				<div class="carousel slide" data-bs-ride="carousel" id="carouselExampleControls">
					<div class="carousel-inner">
						<div class="carousel-item active"><img alt="..." class="d-block w-100" src="https://i.ibb.co/6466FHg/gastro1.png"></div>
						<div class="carousel-item"><img alt="..." class="d-block w-100" src="https://i.ibb.co/zSzvbYQ/gastro2.png"></div>
						<div class="carousel-item"><img alt="..." class="d-block w-100" src="https://i.ibb.co/16GfW1B/edificio2.png"></div>
	...
	<section id="features">
		<section class="section" id="team">
			<div class="container">
				...
				<div class="row"><img alt="" src="https://i.ibb.co/9cYhXcF/Testimonio-gastro.png"></div><!-- end row -->
			</div><!-- end container -->
		</section>
	</section><!-- Footer-->
	<footer id="footer">

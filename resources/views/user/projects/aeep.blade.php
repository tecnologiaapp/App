...
<section>
	...
	<section>
		...
		<div class="container">
			...
			<div align="center">
	<iframe width="1200px" height="1100px" src="https://agenciaapp.maps.arcgis.com/apps/dashboards/c4d6f9703d434fa88b6fd266ae8c3f70" frameborder="0" scrolling="no" style="padding-bottom: 100px;padding-top: 60px;"></iframe>
	</div>
...
<p>El instrumento del AEEP tiene aplicabilidad en todo el subsistema de espacios públicos, con una extensión total de 10,2 km², y está conformado por parques, plazas, franjas de amoblamiento y elemento complementarios como el antejardín en áreas de alta y media mixtura (zonas y corredores con predominancia económica y centralidades urbanas).</p>
                                ...
                                <hr>
								<iframe width="560" height="315" src="https://www.youtube.com/embed/qFS_Gvyi2y8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<hr>
					...
					Actividades permitidas
					   ...
					   <li> <b>Eventos ocasionales con fines económicos.</b> Ocupación del espacio público de forma transitoria con bazares, mercados rotatorios campesinos, festivales, espectáculos, competencias, maratones, entre otros. A partir del 23 de junio de 2021 estos se deberán tramitar a través de la Ventanilla Única Eventos en la página de la Alcaldía de Medellín: 
 <b> <a href="https://www.medellin.gov.co/eventos"> Click aqui</a> </b>
...
<hr>
					<h3 style="text-align:center;">
					Espacios públicos susceptibles de ser aprovechados económicamente
									
								</h3>

<p>
El aprovechamiento económico se podrá realizar en los componentes del Subsistema de Espacio Público de Esparcimiento y Encuentro, y en el Subsistema de Movilidad, en particular sobre los siguientes componentes.
</p>
...
<ul >
                       <li> En las franjas de amoblamiento de los andenes con una sección mínima de 5 metros donde la franja de amoblamiento posea una sección mínima de 3 metros y la franja de circulación, una sección mínima de 2.</li>
						...
						<li> Antejardines en corredores de alta mixtura y frente a vías arterias.
</li>
                        <br>

						<li> Zonas duras de espacios públicos como parques, plazas y plazoletas.
</li>
                        <br>
					  
						<li> Calzadas que cuenten con su respectivo permiso de cierre parcial y transitorio.
...
<hr>
					...
					Cómo se implementa el AEEP
                       ...
                       <li type="circle"> Acuerdo 048 de 2014 - Plan de Ordenamiento Territorial –POT–.</li>
						...
						<li type="circle"> Decreto 113 de 2017 - Manual de Espacio Público –MEP–.
</li>
                        <br>

						<li type="circle"> Acuerdo Municipal 050 de 2015 - Por medio del cual se establece la política pública para la administración, mantenimiento y aprovechamiento económico del espacio público en el Municipio de Medellín.
</li>
                        <br>
					  
						<li type="circle"> Decreto 2148 de 2015 - Por medio del cual se reglamenta el aprovechamiento económico del espacio público, se fijan las retribuciones por su utilización, se crean la Comisión Intersectorial Asesora del Espacio Público y el Comité Técnico.
						...
						<li type="circle">Decreto 0400 de 2017 - Por el cual se reglamenta el funcionamiento, proceso contractual, registro e instalación de los relojes públicos e informadores electrónicos y digitales en el Municipio de Medellín y se dictan otras disposiciones.
						...
						<li type="circle">Decreto 0288 de 2018 - Por el cual se reglamentan los avisos publicitarios en el Municipio de Medellín y se dictan otras disposiciones.

                        </li>
                        <br>

						<li type="circle">Decreto 0522 de 2018 - Por medio del cual se modifica y adiciona el Decreto 2148 de 2015.

                        </li>
                        <br>

						<li type="circle">Decreto 0471 de 2018 - Por medio del cual se expiden las normas reglamentarias de detalle aplicables las actuaciones y procesos de urbanización, parcelación, construcción, reconocimiento de edificaciones y demás actuaciones en el territorio municipal y se dictan otras disposiciones.


                        </li>
                        <br>

						<li type="circle">Decreto 2229 de 2019 –MAEEP–. Por medio del cual se adopta el Manual del Aprovechamiento Económico del Espacio Público en la ciudad de Medellín, se modifican los decretos municipales 2148 de 2015 y 471 de 2018, se deroga el Decreto Municipal 327 de 1997 y se dictan otras disposiciones.
...
<hr>
					...
					Paso a paso 
								...
								Procedimiento para la solicitud de los permisos de ocupación y Aprovechamiento Económico del Espacio Público
					...
					<ul >
					   ...
					   <li> <b>Revisión del proyecto. </b>Verificación del formato bien diligenciado y de todos los anexos necesarios para el trámite de mesas y sillas. 
                        <ol>
							<li type="circle"><b>Sí. </b>Cuando la documentación está completa se continúa con el trámite.
</li>

<li type="circle"><b>No. </b>Se realiza requerimiento solicitando la información. Este se hace con los términos de la Ley 1755 de 2015.

</li>

<li type="square">¿Se obtuvo respuesta al requerimiento en el término de tiempo?</li>

<ol>
<li type="circle"><b>No. </b>Se decreta el desistimiento de la solicitud de conformidad al artículo 17 de la Ley 1755 de 2015, se notifica y archiva.


</li>

<li type="circle"><b>Sí. </b>Continúa el trámite.
					...
					<ol>
						...
						<li type="circle"><b>Negado. </b>El proyecto no cumple con los parámetros técnicos y geoespaciales para el uso del espacio como extensión con mesas y sillas, acorde al instrumento para el AEEP.
</li>
					</ol>
						...
						<li><b>Emisión de concepto. </b>Entrega de concepto técnico y explicación a fondo de la decisión del comité, bien sea aprobada o negada, con o sin retribución económica.
					...
					<ol>
						...
						<li type="circle"><b>No aceptación de la preliquidación. </b>Si el solicitante no está de acuerdo con el valor arrojado por la ocupación del espacio pasamos al punto siguiente (paso 5).
</li>
					</ol>
				...
				<b>	<a href="{{ asset('assets/pdf/aeep/FO GPP 09 003 FORMATO PROYECTO DE OCUPACION AEEP  MESAS Y SILLAS.docx.pdf')}}"  target="_blank"> PROYECTO DE OCUPACIÓN AEEP</a> </b>



					<h3 style="text-align:center;">
					
					Eventos ocasionales con fines económicos
...
<li><b>Revisión. </b>Análisis completo del proyecto y del diligenciamiento del formato. También se revisan todos los anexos necesarios para el trámite de mesas y sillas.
<ol>
...
<a class="button" href="{{ route('user.projects.aeep2') }}">Siguiente página</a>
	...
	<footer class="vlt-single-post__footer">
				...
				<a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="https://twitter.com/intent/tweet?text=https://www.app.gov.co/proyectos/AEEP" rel="nofollow" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>

				<a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="https://www.facebook.com/sharer/sharer.php?u=https://www.app.gov.co/proyectos/AEEP" rel="nofollow" target="_blank"><i class="fa fa-facebook"></i></a>

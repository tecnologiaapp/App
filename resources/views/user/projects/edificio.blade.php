...
<li class="dropdown btn-book-a-table"><a href="{{ asset('assets/pdf/Modernizacion.pdf')}}" class="getstarted scrollto" target="_blank"><span>Conoce más</span></a>
  ...
  <body id="page-top">
       ...
       <div style="padding-top:25px;">
        <picture>
            <source media="(min-width: 800px)" srcset="{{ asset('assets/img/Proyectos/header-edificio.png') }}">
            <source media="(min-width: 330px)" srcset="{{ asset('assets/img/Proyectos/MOBILE-5.png') }}">
            <img src="{{ asset('assets/img/Proyectos/header-edificio.png') }}" style="width:100%">
        </picture>
        </div>
        <!-- <img src="{{ asset('assets/img/Proyectos/header-edificio.png') }}" style="position: relative; width:100%; height:700px; background-size: 100% 100%;" /> -->
        </section>
        ...
        <header class="masthead">
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                            ...
                            <h6 class="display-1 lh-1 mb-3" style="font-size: 2rem;">Una conexión con el deporte y la recreación</h6>
                            <p class="lead fw-normal text-muted mb-5">Es una edificación para satisfacer la demanda generada por eventos masivos y por las prácticas deportivas, las visitas del día a día, la oferta de servicios complementarios y nuevos locales comerciales para los sectores deportivo, gastronómico, farmacéutico, bancario, oficinas y de grandes superficies. </p>
        ...
        <img src="{{ asset('assets/img/Proyectos/banner-edificio1.png') }}" style="width:100%;" />
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://i.ibb.co/PtKZyy6/MULTI3.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://i.ibb.co/VCGFXVr/edificio1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="https://i.ibb.co/L8ZshZw/edificio3.png" class="d-block w-100" alt="...">
    </div>
  </div>
...
<p>Imágenes de referencia sujetas a cambios.</p>
        ...
        <img src="{{ asset('assets/img/Proyectos/banner-edificio.png') }}" style=" width:100%;" />
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <img src="https://i.ibb.co/VtVWC8L/Testimonio-edi.png" alt="">

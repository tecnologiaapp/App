...
<section>
		...
		<div class="vlt-page-title-hero vlt-page-title-hero--work vlt-page-title-hero--lg jarallax">
			...
			<div class="vlt-page-title-hero__content">
				<h1 style="color:white;">Normatividad</h1>
			</div>
		</div>
	</section>
	<section>
		...
		<div class="container">
			<p>Aquí encontrarás toda la normatividad aplicable a la Agencia APP y aquella que se produce en desarrollo de nuestras funciones.</p>
		</div>
		<div class="row">
			<div class="col-sm-12 col-md-10 offset-md-1">
				<div class="mt-5">
					<embed height="292" src="{{asset('assets/pdf/normograma.pdf')}}" type="application/pdf">
				</div>
			</div>
		</div>
	</section>

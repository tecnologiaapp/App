...
<section>
	...
	<section>
		...
		<div class="container mt-5">
			...
			<button class="accordion">2024</button>
				<div class="panel">
					<table class="table table-bordered table-striped custom-table">
						<tbody>
							<tr>
								<td>Mapa de riesgos de corrupción de 2024</td>
								<td>
									<a class="btn btn-primary btn-block" href="{{asset('assets/pdf/control/Mapa-de-Riesgos-de-Corrupción-2024.xlsx')}}" target="_blank">Ver documento</a>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<button class="accordion">2025</button>
				<div class="panel">
					<table class="table table-bordered table-striped custom-table">
						<tbody>
							<tr>
								<td>Plan anual de auditoria de 2025</td>
								<td>
									<a class="btn btn-primary btn-block" href="{{asset('assets/pdf/control/PlanAnualdeAuditorías.pdf')}}" target="_blank">Ver documento</a>
								</td>
							</tr>
						</tbody>
					</table>
			...
			</div><button class="accordion">Informe de Derecho de Autor de Software</button>
			<div class="panel">
			<button class="accordion">2024</button>
				<div class="panel">
					<table class="table table-bordered table-striped custom-table">
						<tbody>
							<tr>
								<td>Informe de Derecho de Autor de Software</td>
								<td>
									<a class="btn btn-primary btn-block" href="{{asset('assets/pdf/control/InformedeDerechodeAutordeSoftware-2024.pdf')}}" target="_blank">Ver documento</a>
								</td>
							</tr>
						</tbody>
					</table>

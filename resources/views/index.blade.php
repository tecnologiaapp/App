		...
		<div class="carousel slide" data-ride="carousel" id="carouselExampleIndicators">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<a href="{{route('user.projects.subasta')}}"><img alt="One slide" class="d-block w-100" src="assets/img/Banners/Banner-Internas.jpg"></a>
				</div>
				<div class="carousel-item">
					<a href="{{route('user.projects.mudag')}}"><img alt="Second slide" class="d-block w-100" src="assets/img/Banners/bannerHome1.jpg"></a>
				</div>
				<div class="carousel-item">
					<a href="{{route('user.noticias.new50')}}"><img alt="Third slide" class="d-block w-100" src="assets/img/Banners/bannerHome2.jpg"></a>
				</div>
				<div class="carousel-item">
					<a href="https://www.instagram.com/s/aGlnaGxpZ2h0OjE3OTg4MDk0NTkyMDA3ODIx?story_media_id=3115907623191126740_6167483428&igshid=MzRlODBiNWFlZA=="><img alt="Four slide" class="d-block w-100" src="assets/img/Banners/bannerHome3.jpg"></a>
				</div>
